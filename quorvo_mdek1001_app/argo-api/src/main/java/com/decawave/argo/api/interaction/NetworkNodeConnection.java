...
public interface NetworkNodeConnection  {
     ...
     */
    void getOtherSideEntity(@NotNull Consumer<NetworkNode> onSuccess, @NotNull Consumer<Fail> onFail,
     ...
     */
    void updateOtherSideEntity(NetworkNode networkNode, boolean operationModeChange, Consumer<WriteEffect> onSuccess, Consumer<Fail> onFail);
     ...
     *
     * @see com.decawave.argo.api.GenericConnectionApi#connect(Object, ConnectPriority, io.reactivex.functions.Consumer, io.reactivex.functions.BiConsumer, io.reactivex.functions.BiConsumer)
     */
    void disconnect();
