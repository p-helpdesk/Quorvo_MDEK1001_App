...
public class SettingsFragment extends AbstractArgoPreferenceFragment {
    ...
    protected void onCreateView(LayoutInflater inflater) {
        ...
        addPreference(inflater,
                ...
                AbstractArgoFragment.daApp.getString(R.string.app_name) + "\n" +
                AbstractArgoFragment.daApp.getString(R.string.settings_about)
                );
    ...
    private String getVersionText() {
        ...
        try {
            ...
            if (tag != null && tag.length() > 0) {
                version.append("\n").append(AbstractArgoFragment.daApp.getString(R.string.pref_firmware)).append(": ").append(tag);
            }
            version.append("\n").append(AbstractArgoFragment.daApp.getString(R.string.pref_build_time)).append(": ").append(BuildConfig.BUILD_TIME);
