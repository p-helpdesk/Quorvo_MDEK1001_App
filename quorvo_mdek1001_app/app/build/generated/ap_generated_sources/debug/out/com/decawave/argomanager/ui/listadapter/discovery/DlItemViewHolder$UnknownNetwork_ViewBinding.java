...
public class DlItemViewHolder$UnknownNetwork_ViewBinding implements Unbinder {
  private DlItemViewHolder.UnknownNetwork target;

  @UiThread
  public DlItemViewHolder$UnknownNetwork_ViewBinding(DlItemViewHolder.UnknownNetwork target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    DlItemViewHolder.UnknownNetwork target = this.target;
