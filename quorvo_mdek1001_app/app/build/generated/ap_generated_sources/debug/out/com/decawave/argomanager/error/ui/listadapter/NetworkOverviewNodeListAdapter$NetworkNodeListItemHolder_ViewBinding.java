...
public class NetworkOverviewNodeListAdapter$NetworkNodeListItemHolder_ViewBinding implements Unbinder {
  ...
  @UiThread
  public NetworkOverviewNodeListAdapter$NetworkNodeListItemHolder_ViewBinding(
      NetworkOverviewNodeListAdapter.NetworkNodeListItemHolder target, View source) {
    this.target = target;
