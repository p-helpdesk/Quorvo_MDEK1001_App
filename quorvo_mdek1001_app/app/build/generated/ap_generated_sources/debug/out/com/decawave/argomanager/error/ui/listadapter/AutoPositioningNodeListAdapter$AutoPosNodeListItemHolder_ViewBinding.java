...
public class AutoPositioningNodeListAdapter$AutoPosNodeListItemHolder_ViewBinding implements Unbinder {
  ...
  @UiThread
  public AutoPositioningNodeListAdapter$AutoPosNodeListItemHolder_ViewBinding(
      AutoPositioningNodeListAdapter.AutoPosNodeListItemHolder target, View source) {
    this.target = target;
